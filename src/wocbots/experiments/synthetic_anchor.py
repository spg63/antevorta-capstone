"""W4-01 — synthetic e2e anchor experiment kind (spec §11 permanent canary)."""
...
from wocbots.experiments.evaluation import evaluation_summary_to_dict, run_test_set
...
register_kind("synthetic_anchor", _synthetic_anchor_runner)
