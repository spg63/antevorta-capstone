...
- `src/wocbots/experiments/lifecycle.py` — arena sample id + history back-fill (sample scoping goes through `ArenaRoundInteractionRunner.begin_sample`, which refuses a re-used scored id)
